    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt):
                if insect.impostor_queen is False:
                    return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while random_or_none(current_place.bees) is None and current_place.entrance is not hive:
...
class ShortThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        while start_place < self.max_range and (
                random_or_none(current_place.bees) == None and current_place.entrance.name != 'Hive'):
            current_place = current_place.entrance
            start_place += 1
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        while start_place <= self.min_range or (
                random_or_none(current_place.bees) == None and current_place.entrance.name != 'Hive'):
            current_place = current_place.entrance
            start_place += 1
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if self.is_container is True and self.contained_ant is None and other.is_container is False:
            return True
        return False
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.impostor_queen = QueenAnt.impostor_queen
        QueenAnt.impostor_queen = True
        self.doubled_ants = []
        # END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if self.impostor_queen is True:
        ...
        while behind_queen is not None:
            if behind_queen.ant is not None:
                if isinstance(behind_queen.ant, BodyguardAnt):
                    if behind_queen.ant not in self.doubled_ants:
                        behind_queen.ant.damage *= 2
                        self.doubled_ants.append(behind_queen.ant)
                    if behind_queen.ant.contained_ant is not None and behind_queen.ant.contained_ant not in self.doubled_ants:
                        behind_queen.ant.contained_ant.damage *= 2
                        self.doubled_ants.append(behind_queen.ant.contained_ant)
                else:
                    if behind_queen.ant not in self.doubled_ants:
                        behind_queen.ant.damage *= 2
                        self.doubled_ants.append(behind_queen.ant)

            """if behind_queen.exit is None and len(behind_queen.bees) > 0:
                bees_win()"""
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        self.armor -= amount
        if self.armor <= 0 and self.impostor_queen is False:
            bees_win()
        # END Problem 13
